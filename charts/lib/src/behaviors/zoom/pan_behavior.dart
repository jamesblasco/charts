...
class PanBehavior<D> extends ChartBehavior<D> {
  ...
  @override
  PanBehaviorState<D> createBehaviorState() {
...
/// Class extending [PanBehavior] with fling gesture support.
class FlutterPanBehavior<D> = PanBehaviorState<D> with FlutterPanBehaviorMixin;

/// Mixin that adds fling gesture support to [PanBehavior] or subclasses
/// thereof.
mixin FlutterPanBehaviorMixin<D> on PanBehaviorState<D>
  ...
  @override
  bool onTapTest(Offset chartPoint) {
