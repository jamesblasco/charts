...
class SankeyGraph<N, L, D> extends Graph<N, L, D> {
  ...
  SankeyGraph._({
    ...
    required TypedAccessorFn<GraphLink<N, L>, D> linkDomainFn,
    required TypedAccessorFn<Node<N, L>, num?> nodeMeasureFn,
    required TypedAccessorFn<GraphLink<N, L>, num?> linkMeasureFn,
    ...
    TypedAccessorFn<GraphLink<N, L>, Color>? linkFillColorFn,
  }) : super.base(
            id: id,
            nodes: nodes,
            links: links,
...
List<Node<N, L>> topologicalNodeSort<N, L, D>(
    ...
    TypedAccessorFn<GraphLink<N, L>, D> linkDomainFn) {
...
/// A Sankey specific [GraphLink] in the graph.
///
...
class SankeyLink<N, L> extends GraphLink<N, L> {
