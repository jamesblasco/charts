...
class SelectionScatterPlotHighlight extends StatelessWidget {
  ...
  static List<Series<LinearSales, int>> _createSampleData() {
    final data = [
      ...
      // Render a hollow circle, filled in with white.
      LinearSales(13, 225, 5.0, 'circle', Colors.white, 2.0),
      ...
      // Render a hollow circle, filled in with white.
      LinearSales(45, 300, 8.0, 'circle', Colors.white, 2.0),
      LinearSales(52, 15, 4.0, null, null, null),
      // Render a hollow square, filled in with white.
      LinearSales(56, 200, 7.0, null, Colors.white, 2.0),
    ];
