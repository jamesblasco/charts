...
void main() {
  ...
  group('edge cases', () {
    test('hit target on missing data in group should highlight group', () {
      ...
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(70.0 + 10.0 + 20.0, 20.0 + 100.0 - 5.0),
  ...
  group('Vertical BarRenderer', () {
    test('hit test works on bar', () {
      ...
      // Act
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(70.0 + 10.0 + 13.0, 20.0 + 100.0 - 5.0),
          selectNearestByDomain,
          null);
    ...
    test('hit test works above bar', () {
      ...
      // Act
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(70.0 + 10.0 + 13.0, 20.0), selectNearestByDomain, null);
    ...
    test('hit test works between bars in a group', () {
      ...
      // Act
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(70.0 + 10.0 + 50.0, 20.0 + 100.0 - 5.0),
          selectNearestByDomain,
          null);
    ...
    test('no selection for bars outside of viewport', () {
      ...
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(65.0, 20.0 + 100.0 - 5.0), selectNearestByDomain, null);
  ...
  group('Horizontal BarRenderer', () {
    test('hit test works on bar', () {
      ...
      // Act
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(70.0 + 5.0, 20.0 + 10.0 + 13.0), selectNearestByDomain, null);
    ...
    test('hit test expands to grouped bars', () {
      ...
      // Act
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(70.0 + 5.0, 20.0 + 10.0 + 20.0), selectNearestByDomain, null);
    ...
    test('hit test works above bar', () {
      ...
      // Act
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(70.0 + 100.0, 20.0 + 10.0 + 20.0),
          selectNearestByDomain,
          null);
    ...
    test('hit test works between bars in a group', () {
      ...
      // Act
      final details = renderer.getNearestDatumDetailPerSeries(
          Offset(70.0 + 5.0, 20.0 + 10.0 + 50.0), selectNearestByDomain, null);
