...
class FakeChart extends BaseRenderChart {
  @override
...
void main() {
  ...
  InitialSelectionState _makeBehavior(SelectionModelType selectionModelType,
      {List<String> selectedSeries, List<SeriesDatumConfig> selectedData}) {
    InitialSelectionState behavior = InitialSelectionState(
