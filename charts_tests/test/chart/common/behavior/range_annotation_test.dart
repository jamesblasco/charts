...
class ConcreteChart extends LineRenderChart {
...
void main() {
  Rect drawBounds;
  Rect domainAxisBounds;
  Rect measureAxisBounds;
  ...
  setUpAll(() {
    ...
    domainAxisBounds = Rect.fromLTWH(0, 0, 100, 100);
    measureAxisBounds = Rect.fromLTWH(0, 0, 100, 100);
  });
  ...
  group('RangeAnnotationState', () {
    test('renders the annotations', () {
      // Setup
      final behavior = RangeAnnotationState<num>(_annotations1);
    ...
    test('extends the domain axis when annotations fall outside the range', () {
      // Setup
      final behavior = RangeAnnotationState<num>(_annotations2);
      final tester = RangeAnnotationTester(behavior);
      behavior.attachTo(_chart);
    ...
    test('test dash pattern equality', () {
      // Setup
      final behavior = RangeAnnotationState<num>(_annotations3);
      final tester = RangeAnnotationTester(behavior);
      behavior.attachTo(_chart);
