...
class MockBehavior extends Mock implements ChartBehaviorState<String> {}

class ParentBehavior implements ChartBehaviorState<String> {
  final ChartBehaviorState<String> child;
  ...
  @override
  void attachTo(BaseRenderChart chart) {
    chart.addBehavior(child);
  }

  @override
  void removeFrom(BaseRenderChart chart) {
    chart.removeBehavior(child);
  }
}

class ConcreteChart extends BaseRenderChart<String> {
  @override
