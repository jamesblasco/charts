...
class ConcreteSeriesLegend<D> extends SeriesLegendBehaviorState<D> {
...
void main() {
  ...
  test('Legend entries created on chart post process', () {
    ...
    final legend =
        SeriesLegendBehaviorState<String>(selectionModelType: selectionType);
  ...
  test('generated legend entries use provided formatters', () {
    ...
    final legend = SeriesLegendBehaviorState<String>(
